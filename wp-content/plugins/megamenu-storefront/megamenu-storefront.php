 ...
 * Description: Integrates Max Mega Menu with the WooCommerce StoreFront theme.
 * Version:     1.0
 * Author:      Tom Hemsley
...
if ( ! function_exists( 'megamenu_storefront_css' ) ) {
   function megamenu_storefront_css() {
        if ( function_exists('max_mega_menu_is_enabled') && max_mega_menu_is_enabled('primary') ) {
...
add_action( 'wp_enqueue_scripts', 'megamenu_storefront_css' );
