...
function thegem_loop_shop_per_page() {
	$pc = !empty($_REQUEST['product_count']) && intval($_REQUEST['product_count']) > 0 ? intval($_REQUEST['product_count']) : 220;
	return $pc;
}
add_filter('loop_shop_per_page', 'thegem_loop_shop_per_page', 150);
...
if(function_exists('thegem_is_plugin_active') && !thegem_get_option('catalog_view') && thegem_is_plugin_active('yith-woocommerce-wishlist/init.php')) {
