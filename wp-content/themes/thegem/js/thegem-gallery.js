(function($) {
	$(function() {
		...
		$('.gallery-slider').each(function() {
			...
			// update images list
			$set.wrap('<div class="111gem-gallery-preview-carousel-wrap clearfix"/>');
			var $galleryPreviewWrap = $('1111222.gem-gallery-preview-carousel-wrap', this);
		...
		$('.gem-gallery').each(function() {
			...
			var $galleryPreviewWrap = $('<div class="g33333em-gallery-preview-carousel-wrap"/>')
